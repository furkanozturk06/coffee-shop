...
namespace Coffee_Shop
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            tbSum.Text += "Fulya'm Kafe" + "\r\n\r\n";
            tbSum.Text += "Kızılay Meydanı, Karanfil Sokak 06 Ankara " + "\r\n\r\n";
        ...
        private void btnBuyAll_Click(object sender, EventArgs e)
        {
            if (allert == false)
            {
                ...
                tbSum.Text += "\r\n\r\n" + "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - " + "\r\n\r\n";
                tbSum.Text += "TUTAR: " + total.getSum().ToString() + "₺\r\n\r\n";
                tbSum.Text += "VERGİ: " + total.getTax() + "₺\r\n\r\n";
                tbSum.Text += "TOPLAM TUTAR: " + total.sumTax() + "₺\r\n\r\n";
                tbSum.Text += DateTime.Now.ToString() + "\r\n\r\n";
                tbSum.Text += "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - " + "\r\n\r\n";
                tbSum.Text += "Bizi seçtiğiniz için teşekkürler, Yine bekleriz!" + "\r\n\r\n";
                tbSum.Text += "Fulya Nur Öztürk";
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            if (allert == false)
            {
                MessageBox.Show("Fişi yazdırmadan önce herhangi bir ürün satın almalısınız!");
            }
        ...
        private void cbFlatMilk_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void cbMacSugar_CheckedChanged(object sender, EventArgs e)
        {
